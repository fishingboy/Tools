...
require_once 'D:\www\www_ci\application\models\cal_model.php'; 

class cal_modelTest extends PHPUnit_Framework_TestCase 
{
    public function testCase1() 
    {
        $cal_model = new cal_model(); 
        $this->assertEquals(3, $cal_model->add(1, 2)); 
    }

    public function testCase2() 
    {
        $cal_model = new cal_model(); 
        $this->assertEquals(5, $cal_model->add(3, 2)); 
    }

    public function testCase3() 
    {
        $cal_model = new cal_model(); 
        $this->assertEquals(0, $cal_model->add(3, 2)); 
    }
} 
?>