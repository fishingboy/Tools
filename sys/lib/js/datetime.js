...
return "Incorrect format: " + unit + " \"" + curChar + "\" or \"" + curChar +
nextChar + "\".";
}
...
return "Incorrect format: " + unit + " \"" + dateStr.substr(strInd,2) + 
"\".";
}
switch (tokArr[tokInd].token.toLowerCase()) {
...
return "Incorrect format: Year \"" + dateStr.substr(strInd,2) + 
"\". should be YYYY .";
   }
}
break;
...
return "Incorrect format: Year \"" + dateStr.substr(strInd,4) + 
"\". should be YYYY . ";
}
break;
case 'mon':
...
if (tokInd != tokArr.length || strInd != dateStr.length) 
{
    ...
    if (formatStr == "%yyyy-%mm-%dd")
        return "\"" + dateStr + "\" Incorrect format. Require: YYYY-MM-DD";
    else if (formatStr == "%yyyy-%mm-%dd %hh:%mins")
        return "\"" + dateStr + "\" Incorrect format. Require: YYYY-MM-DD HH:MIN";
    else
        return "\"" + dateStr + "\" Incorrect format. Require: " + formatStr;
    }
    ...
    {
        return "Month should be 01 ~ 12.";
    }
    if (intDay < 1 || intDay > 31) 
    {
        return "Day should be 01 ~ 31.";
    }
...
{
	return "Minute should be 00 ~ 59.";
}
if (intSec < 0 || intSec > 59) 
{
	return "Second should be 00 ~ 59.";
}
